...
public class Main {
    public static void main(String[] args) {
        ...
        Iterator<MenuItem> a = kiosk.menuItems.iterator();
        ...
        while (true) {
            ...
            try { // 문자가 들어올 시 예외처리
                ...
                if (selectMenu > 0 && selectMenu <= kiosk.menuItems.size()) {
                    System.out.println("선택한 메뉴는: " + kiosk.menuItems.get(selectMenu - 1));
                } else {
