...
public class Main {
    public static void main(String[] args) {
        ...
        Iterator<MenuItem> e = menuItem.arrayList.iterator();
        while (e.hasNext()){   //hasNest()는 다음요소가 존재하는가? true면 next()를 호출
        ...
        while (true) {
            ...
            if (selectMenu >= 0 && selectMenu < menuItem.arrayList.size()) {
                System.out.println("선택한 메뉴는: " + menuItem.arrayList.get(selectMenu - 1));
            } else {
